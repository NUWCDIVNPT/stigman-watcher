...
.option('--stability-threshold <ms>', 'Milliseconds to wait for file size to stabilize. May be helpful when watching network shares.', parseIntegerArg, parseIntegerEnv(pe.WATCHER_STABILITY_THRESHOLD) ?? 0)
