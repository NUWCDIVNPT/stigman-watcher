...
class Alarm extends EventEmitter {
    ...
    constructor () {
        super()
        // concurrent backpressure waits in parseQueue each add a
        // temporary alarmRaised listener, which can exceed the default
        // limit of 10 when combined with the persistent listeners
